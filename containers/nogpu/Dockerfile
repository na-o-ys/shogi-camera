...
RUN apt-get update && \
    apt-get install -y git wget sudo g++ python-dev python-pip python3-dev python3-pip && \
...
RUN pip3 install scipy scikit-learn pandas matplotlib jupyter tensorflow Pillow h5py keras
